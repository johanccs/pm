    ...
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden">
      ...
      <div className="relative w-full max-w-sm px-4">
        <div className="rounded-[32px] border border-[var(--stroke)] bg-white/80 p-10 shadow-[var(--shadow)] backdrop-blur">
          ...
          {/* Accent line */}
          <div className="mt-6 h-px w-full bg-[var(--accent-yellow)]" />
          ...
          <form onSubmit={handleSubmit} className="mt-8 flex flex-col gap-5">
            ...
            <button
              type="submit"
              disabled={loading}
              className="mt-1 rounded-xl bg-[var(--secondary-purple)] px-6 py-3 text-sm font-semibold text-white transition hover:opacity-90 disabled:opacity-50"
            >
